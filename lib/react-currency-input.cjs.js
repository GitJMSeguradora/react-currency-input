  ...
  CurrencyInput.prototype.render = function render () {
    ...
    return (
      React__default.createElement( 'input', Object.assign({},
        ...
        }, type: this.props.inputType, value: this.state.maskedValue, onChange: this.handleChange, onFocus: this.handleFocus, onMouseUp: this.handleFocus }, this.state.customProps))
    );
  };
