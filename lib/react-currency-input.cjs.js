...
function mask(value, precision, decimalSeparator, thousandSeparator, allowNegative, prefix, suffix, event) {
...
var CurrencyInput = (function (Component$$1) {
  ...
  CurrencyInput.prototype.componentDidUpdate = function componentDidUpdate (prevProps, prevState) {
    ...
    var separatorsRegex = new RegExp(
   ...
   * @param event 
   */
  CurrencyInput.prototype.handleOnKeyDown = function handleOnKeyDown (event) {
    if (event.keyCode === 8) {
  ...
  CurrencyInput.prototype.render = function render () {
    ...
    return (
      React__default.createElement( 'input', Object.assign({},
        ...
        }, type: this.props.inputType, value: this.state.maskedValue, onChange: this.handleChange, onFocus: this.handleFocus, onMouseUp: this.handleFocus, onKeyDown: this.handleOnKeyDown }, this.state.customProps))
    );
  };
